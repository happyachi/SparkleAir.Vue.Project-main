...
// import SonCoupon from "@/components/flightWebComponents/Campaigns/CouponInCart.vue";
                ...
                <div class="wizard-content overflow-visible mb-24">
                  <fieldset id="step-2" class="tab-pane show wizard-fieldset p-0">
                    <div id="wizardValidator">
                      ...
                      <div class="detail-form term_conditions mb-32">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <p class="dark-gray mb-24 fw-400">
                            ...
                            <div class="filter-checkbox mb-24">
                              ...
                              <label for="save" class="dark-gray fw-400"
                                >Save my detail so i can book faster next time.</label
                              >
                            </div>
                            <p class="dark-gray fw-400">
                              By signing in or creating an account, you agree with our
                              <a href="privacy-policy.html" class="color-primary">
                                Terms & conditions</a
                              >
                            </p>
                            <div class="wizard-form-error"></div>
                  ...
                  <fieldset id="step-3" class="tab-pane wizard-fieldset p-0">
                      ...
                      <div class="custom-control">
                        <div class="radio-button mb-24">
                          <input
                            type="radio"
                            name="payment"
                            class="custom-control-input input-control"
                            id="later"
                          />
                          <!-- <div class="wizard-form-error"></div> -->
                          <label
                            class="custom-control-label paynow color-black"
                            for="later"
                            >Pay Later</label
                          >
                        ...
                        <div class="radio-button">
                          ...
                          />
                          <!-- <div class="wizard-form-error"></div> -->
                          <label class="custom-control-label paynow color-black" for="now"
                            >Pay Now</label
                          >
                          <p class="dark-gray pl-36">
                            Lorem ipsum dolor sit amet consectetur. Orci elementum egestas
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="input-container">
                                <input
                                  id="payment"
                                  class="radio-button wizard-required"
                                  type="radio"
                                  name="radio"
                                  value="payment"
                                />
                                ...
                                <div class="radio-tile wizard-page">
                                  <label
                                    for="payment"
                                    class="radio-tile-label wizard-label"
                            ...
                            <div class="col-sm-6">
                              <div class="input-container">
                                ...
                                <div class="wizard-form-error"></div>
                                <div class="radio-tile wizard-page">
                                  <label for="g-pay" class="radio-tile-label wizard-label"
                                    ><img
                    ...
                    <div class="d-flex gap-24 mt-24">
                      ...
                      <a href="" class="form-wizard-next-btn cus-btn w-100"> Submit </a>
                    </div>
                  </fieldset>
                </div>
          ...
          <div class="col-xl-4 mb-lg-0 mb-32">
            <div class="flight-booking-detail light-shadow mb-32">
              <div class="flight-title">
                <h4 class="color-white">Your Booking Detail</h4>
              </div>
              <div class="box bg-white p-24">
                <div class="flight-detail mb-32">
                  ...
                  <div class="d-inline-flex align-items-center gap-8">
                    ...
                    <div class="from-to text-center">
                      ...
                      <img src="../src/moban7664/static/picture/route-plan.png" alt="" />
                ...
                <div class="d-flex justify-content-around mb-32">
                  <div class="flight-departure">
                    ...
                    <h5 class="color-black">14 Aug, 2023</h5>
                  </div>
            ...
            <div class="flight-booking-detail light-shadow">
              ...
              <div class="box bg-white p-24">
                ...
                <div class="d-flex align-items-center justify-content-between mb-24">
                  ...
                  <h5 class="color-black">$640</h5>
                </div>

                <hr class="bg-medium-gray mb-24" />
                <div class="d-flex align-items-center justify-content-between mb-24">
                  <div>
                    <a :href="`http://localhost:8888/couponcart`" @get-message="getCoupon">優惠券</a>
                    <!-- <h4 class="color-black">
                                            優惠券
                                        </h4> -->
                  </div>
                  <h4 class="color-black">$40</h4>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <h4 class="color-black">Total</h4>
                  </div>
                  <h4 class="color-black">$600</h4>
                </div>
              </div>
            </div>
          </div>
