                  ...
                  >
                    ...
                    >
                      <div class="custom-sel-input-block">
                        <label for="depFrom" class="h-16 color-medium-gray"
                          >From</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="custom-sel-input-block">
                        <label for="arrivalTo" class="h-16 color-medium-gray"
                          >To</label
                        >
                        <input
                          type="text"
                    ...
                    <div class="d-xl-flex align-items-center gap-24 d-lg-block">
                      <div class="input-date-picker">
                        <label for="dep" class="h-16 color-medium-gray"
                          >Departing</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="input-date-picker">
                        <label for="arrival" class="h-16 color-medium-gray"
                          >Returning</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="custom-sel-input-block">
                        ...
                        <div class="seat-booking color-black">
                          <span class="total-pasenger">2</span>
                          Passengers /
                        ...
                        >
                          ...
                          <p class="color-medium-gray light mb-32">
                            Please note: You can book for a maximum of nine
                            passengers.
                          </p>
                          ...
                          <div class="radio-tile-group">
                            <div class="input-container">
                              ...
                              <div class="radio-tile">
                                <label for="economy" class="radio-tile-label"
                                  >Economy</label
                                >
                              </div>
                            </div>
                            <div class="input-container">
                              ...
                              />
                              <div class="radio-tile">
                                <label for="business" class="radio-tile-label"
                                  >Business</label
                                >
                              </div>
                            </div>
                            <div class="input-container">
                              ...
                              />
                              <div class="radio-tile">
                                <label for="firstClass" class="radio-tile-label"
                                  >First Class</label
                                >
                              </div>
                            </div>
                            <div class="input-container">
                              ...
                              />
                              <div class="radio-tile">
                                <label for="pre-eco" class="radio-tile-label"
              ...
              <div class="tab-pane" id="stopover">
                <form action="flight-listing.html" method="post">
                  <div class="custom-control mb-32">
                    <div class="radio-button">
                      <input
                        ...
                        id="way"
                      />
                      <label class="custom-control-label" for="way"
                        >One way</label
                      >
                    </div>
                    <div class="radio-button">
                      <input
                        ...
                        id="trip"
                      />
                      <label class="custom-control-label" for="trip"
                        >Round-trip</label
                      >
                    </div>
                    <div class="radio-button">
                  ...
                  <div class="booking-info mb-32">
                    ...
                    >
                      <div class="custom-sel-input-block">
                        <label for="flightFrom" class="h-16 color-medium-gray"
                          >From</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="custom-sel-input-block">
                        <label for="flightGo" class="h-16 color-medium-gray"
                          >To</label
                        >
                        <input
                          type="text"
                    ...
                    <div class="d-xl-flex align-items-center gap-24 d-lg-block">
                      <div class="input-date-picker">
                        <label for="flightgone" class="h-16 color-medium-gray"
                          >Departing</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="input-date-picker">
                        <label for="returnTime" class="h-16 color-medium-gray"
                          >Returning</label
                        >
                        <input
                          type="text"
                      ...
                      <div class="custom-sel-input-block">
                        <div class="h-16 color-medium-gray" id="passengers">
                          Passengers and Class
                        </div>
                        <div class="seat-booking color-black">
                          <span class="total-pasenger">2</span>
                        ...
                        >
                          ...
                          <div class="radio-tile-group">
                            <div class="input-container">
                              ...
                              />
                              <div class="radio-tile">
                                <label for="economybtn" class="radio-tile-label"
                                  >Economy</label
                                >
                              </div>
                            </div>
                            ...
                            <div class="input-container">
                              ...
                              />
                              <div class="radio-tile">
                                <label for="pre-ecoBtn" class="radio-tile-label"
                                  >Premium Economy</label
                                >
                              </div>
                            </div>
                  ...
                  <div class="row">
                    ...
                    >
                      <h5 class="color-medium-gray mb-24">
                        When would you like to add a stop in dubai during your
                        journey?
                      </h5>
                      <div class="custom-control">
                        <div class="radio-button">
                          <input
                            ...
                            id="departure"
                          />
                          <label class="custom-control-label" for="departure"
                            >Departure</label
                          >
                        </div>
                        <div class="radio-button">
                    ...
                    <div class="col-xl-2 d-flex align-items-center">
                      <button type="submit" class="cus-btn mt-lg-0 mt-32">
                        Show Flight
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
            ...
            >
              <div class="flight-area">
                ...
                <div class="flight-button">
                  ...
                  <a href="flight-booking.html" class="cus-btn btn-sec"
                    >Book Now</a
                  >
                </div>
              </div>
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a
                    ...
                    aria-expanded="true"
                  >
                    <i class="fa-solid fa-chevron-down color-primary"></i
                    >&nbsp;Flight Detail</a
                  >
                </div>
              </div>
