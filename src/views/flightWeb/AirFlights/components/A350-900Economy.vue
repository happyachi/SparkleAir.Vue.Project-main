...
const seatLetter = ref(["A", "B", "C", "D", "E", "G", "H", "J", "K"])
...
const emits = defineEmits(["update:economySeat"])
...
const updateSeat = async () => {
    ...
    seats.value.forEach((seat) => {
        try {
            if (seat.isSeated === true && seat.airCabinId === 4) {
        ...
        <div class="cabinContainer" border="0" cellspacing="0" cellpadding="0">
            ...
            >
                <tbody class="body">
                            ...
                            <tr class="seats-row">
                                ...
                                <td :id="`td${num}${seatLetter[0]}`">
                                    <div
                                        ...
                                        aria-hidden="true"
                                    >
                                        <i class="fa-solid fa-xmark exits"></i>
                                    </div>
                                </td>
                    ...
                    <template v-for="num in 69">
                        <template v-if="num == 50">
                            <tr class="seats-row">
                                <td>
                                    <div
                                        aria-hidden="true"
                            ...
                            <tr class="seats-row">
                                <td>
                                    <div
                                        aria-hidden="true"
                                        aria-label="Left"
                                        class="EmptySquare Square inMiddle"
                                    ></div>
                                </td>
                                <td>
                                    <div
                                ...
                                <td>
                                    <div
                                        class="EmptySquare Square inMiddle restroom"
                                        aria-hidden="true"
                                    ></div>
                                </td>
                                <td>
                        ...
                        <template v-if="num == 51">
                            <tr class="seats-row">
                                <td>
                                    ...
                                    >
                                        <i
                                            class="fa-solid fa-right-from-bracket exits exit-left"
                                        ></i>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    >
                                        <i
                                            class="fa-solid fa-right-from-bracket exits exit-right"
                                        ></i>
                                    </div>
                                </td>
                            </tr>
                        </template>
                        <template v-if="num >= 52 && num <= 53">
                            <tr class="seats-row">
                                <td>
                                    <div
                                        aria-hidden="true"
