...
const manageBookingBtn = async () => {
  console.log(manageBookingBookRef.value);
  console.log(manageBookingFirstName.value);
  console.log(manageBookingLastName.value);
                  ...
                  <div class="card-body tab-content">
                                ...
                                <div class="row">
                                  <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="custom-sel-input-block v-2">
                                      <input type="text" class="sel-input" name="reference" id="ref-name"
                                        placeholder="機票號碼" :model="manageBookingBookRef" />
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="custom-sel-input-block m-0">
                                      <input type="text" class="sel-input" name="name" id="last-name" placeholder="姓氏"
                                        :model="manageBookingLastName" />
                                    </div>
                                  </div>
                                  <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="custom-sel-input-block m-0">
                                      <input type="text" class="sel-input" name="name" id="first-name" placeholder="名字"
                    ...
                    <div class="tab-pane" id="status">
                      <div class="booking-bar">
                        <ul class="nav nav-tabs" data-bs-tabs="tabs">
                          <li class="nav-item">
                            <a href="#byRoute" class="nav-link active" aria-current="true" data-bs-toggle="tab">
                              依航線
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="#flightNo" class="nav-link" aria-current="false" data-bs-toggle="tab">
                              依航班號碼
                            </a>
                          </li>
                        </ul>
                            ...
                            <div class="row align-items-center">
                              <div class="col-xl-10 col-lg-10">
                                <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                  <div class="custom-sel-input-block m-0">
                                    <input type="text" class="sel-input auto-input" id="flightDepart"
                                      placeholder="出發地" />
                                  ...
                                  <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                    ...
                                    <input type="text" class="sel-input auto-input" id="flightArrive"
                                      placeholder="目的地" />
                                    <div class="slector-wrapper"></div>
                                  </div>
                                  ...
                                  <div>
                                    <div class="input-date-picker date-time m-0">
                                      <input type="text" class="sel-input date_from" id="flightTimeDate"
                                        placeholder="Aug 20, 2023" />
                                    </div>
                                  </div>
                                </div>
                          ...
                          <form action="flight-listing.html" method="post">
                            <div class="row align-items-center">
                              <div class="col-xl-10 col-lg-10">
                                <div class="booking-info v-2 d-md-flex d-inline-block justify-content-between">
                                  <div class="custom-sel-input-block m-0">
                                    <input type="text" class="sel-input auto-input" id="flightDepat"
                                      placeholder="From" />
                                    <div class="slector-wrapper"></div>
                                  </div>
                                  <div class="custom-sel-input-block m-0 d-flex flex-row align-items-center">
                                  ...
                                  <div>
                                    <div class="input-date-picker date-time m-0">
                                      <input type="text" class="sel-input date_from" id="flightTieDate"
                                        placeholder="Aug 20, 2023" />
                                    </div>
                                  </div>
                                </div>
